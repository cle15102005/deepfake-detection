...
def create_model(INPUT_SHAPE, DROPOUT_RATE, NUM_CLASSES):
    print("  Building EfficientNetB0 model for deepfake detection...\n")
    ...
    # Create final model
    model = models.Model(inputs=base_model.input, outputs=output, name='EfficientNetB0_DeepfakeDetector')
